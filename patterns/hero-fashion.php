...
$cover_image_url = get_theme_file_uri( 'assets/images/pexels-spencer-selover-428338.jpg' );
?>

<!-- wp:cover {"url":"<?php echo esc_url( $cover_image_url ); ?>","id":841,"hasParallax":true,"dimRatio":540,"minHeight":50,"minHeightUnit":"vw","contentPosition":"center center","align":"full"} -->
<div class="wp-block-cover alignfull has-parallax" style="background-image:url(<?php echo esc_url( $cover_image_url ); ?>);min-height:50vw">
	...
	<div class="wp-block-cover__inner-container">
		...
		<h2 class="has-text-align-center blockette-animate blockette-move-down has-white-color has-text-color has-big-font-size" style="font-style:normal;line-height:1.2;letter-spacing:-0.03em;margin-bottom:10px">
			<?php echo esc_html_x( 'Fashion Statements and Apparel', 'Sample text for the heading', 'blockette' ); ?>
		</h2>
		<!-- /wp:heading -->
		...
		<p class="has-text-align-center blockette-animate blockette-move-down blockette-delay-1 has-white-color has-text-color has-medium-font-size">
			<?php echo esc_html_x( 'Browse our Catalog for the Best Products', 'Sample text for the section', 'blockette' ); ?>
		</p>
		<!-- /wp:paragraph -->

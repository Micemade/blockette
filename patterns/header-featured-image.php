 ...
 * Slug: blockette/header-featured-image
 * Categories: featured
...
<div class="wp-block-cover alignwide is-light" style="min-height:470px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-columns" style="margin-bottom:0px">
			...
			<div class="wp-block-column is-vertically-aligned-center">
				<!-- wp:post-title {"textColor":"white","className":"is-style-blockette-text-shadow","fontSize":"x-large"} /-->
